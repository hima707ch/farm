...
const Product = () => {
  ...
  async function fetchProducts(filter){
    ...
    let resp = await axios.get(`https://jdgsjq-4000.csb.app/api/v1/products?page=1&limit=8&${ query }`,{ withCredentials: true });
    setProducts(resp.data.products);

    resp = await axios.get(`https://jdgsjq-4000.csb.app/api/v1/products?page=1&limit=8&city=jaipur`,{ withCredentials: true });
    setjaipurprod(resp.data.products);

    resp = await axios.get(`https://jdgsjq-4000.csb.app/api/v1/products?page=1&limit=8&category=tractor`,{ withCredentials: true });
