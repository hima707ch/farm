...
const ItemCard = ({prod}) => {
  ...
  async function getItem(){
    const resp = await axios.get(`https://jdgsjq-4000.csb.app/api/v1/product/${prod.productId}`,{ withCredentials: true });
  ...
  async function removeItem(){
    const resp = await axios.put(`https://jdgsjq-4000.csb.app/api/v1/cart`,{ type:'remove', productId : prod.productId },{ withCredentials: true });
